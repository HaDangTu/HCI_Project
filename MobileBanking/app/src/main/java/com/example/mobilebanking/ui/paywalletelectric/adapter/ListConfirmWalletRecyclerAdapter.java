...
public class ListConfirmWalletRecyclerAdapter extends RecyclerView.Adapter {
    private ArrayList<ReceiverInfo> receiverInfos;
    private Context context;

    public ListConfirmWalletRecyclerAdapter(ArrayList<ReceiverInfo> receiverInfos, Context context){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.nameTextView.setText(receiverInfo.getTypeWallet());
