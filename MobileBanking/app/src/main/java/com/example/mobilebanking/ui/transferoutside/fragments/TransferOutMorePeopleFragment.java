 ...
 */
public class TransferOutMorePeopleFragment extends Fragment {

    private FloatingActionButton nextFAB;

    public TransferOutMorePeopleFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_transfer_outside_more_people, container, false);
    ...
    private void nextFABOnClick(){
        ConfirmTransferOutMorePeopleFragment fragment = new ConfirmTransferOutMorePeopleFragment();
